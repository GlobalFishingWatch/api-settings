module.exports = {
  async get() {
    ...
    // SELECT mrgid as id, iso_ter1 as iso, geoname as name, ST_Extent(the_geom) as bbox FROM eez GROUP BY id, name
    // bounds in [minX, minY, maxX, maxY]
    return [
      {
        id: '3293',
        label: 'Belgian EEZ',
      ...
      {
        id: '22756',
        label: 'Chilean EEZ (San Felix and San Ambrosio islands)',
        bounds: [
          -83.8278031323647,
          -29.6983584043638,
          -76.1531501288059,
